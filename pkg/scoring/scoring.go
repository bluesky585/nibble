...
// WordTerms lowercases and keeps runs of letters and digits. Punctuation
// and whitespace never become terms, so "cat," matches "cat" and a
// query of punctuation alone yields nothing.

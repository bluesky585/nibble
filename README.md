...
```bash
go get github.com/bluesky585/nibble@v0.7.0
go install github.com/bluesky585/nibble/cmd/nibble@v0.7.0
go install github.com/bluesky585/nibble/cmd/nibble-api@v0.7.0
```
